...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("Video anime")==0 || (event.body.indexOf("Vdani")==0) || event.body.indexOf("Videoanimeanime")==0 ||
event.body.indexOf("Anime")==0 ||
event.body.indexOf("Vdanime")==0 ||
event.body.indexOf("Ani")==0) {
    const axios = global.nodemodule["axios"];
const request = global.nodemodule["request"];
const fs = global.nodemodule["fs-extra"];

     api.sendMessage("muốn xem anime à chờ xíu\n🔥🔥🔥", event.threadID, event.messageID);
...
"https://i.imgur.com/EQSRSLo.mp4"
     ...
     var callback = () => api.sendMessage({body:` 🔥video anime 🔥 `,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"), event.messageID);  
