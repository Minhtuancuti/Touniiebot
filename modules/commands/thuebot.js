...
exports.run = function (o) {
   ...
   if (!["100042167594620"].includes(o.event.senderID)) return send(`⚠️ Chỉ Mochi Kawaiii mới có thể sử dụng!`);
   ...
   switch (o.args[0]) {
      case 'add': {
         ...
         send(`☑️ Đã thêm group thuê bot vào danh sách!\n📢Lưu ý: Hok spam, chửi hay kick bot nhó!\n💝Iu tất cả mụi ngừi💕\n📎Nếu bot có trục trặc thì liên hệ Admin nhó!`);
         break;
      }
      case 'list': {
