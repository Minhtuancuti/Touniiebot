...
module.exports.handleReply = async ({ event, api, handleReply, Currencies, getText }) => {
  ...
  var coinsdd = Math.floor(Math.random() * 50000000) + 500; //random coins khi đào đá
  ...
  var coinsktf = Math.floor(Math.random() * 30000000) + 4200;
  ///////------------random thêm việc cần làm.-----------------////////
  var rdcn = ['𝟭 𝗞𝗶𝗹𝗹', '𝟱 𝗞𝗶𝗹𝗹', '𝟯 𝗞𝗶𝗹𝗹', '𝟭𝟵 𝗞𝗶𝗹𝗹', '𝟭𝟴 𝗞𝗶𝗹𝗹', '𝟯 𝗞𝗶𝗹𝗹', '𝗧𝗼𝗽𝟭 𝗩𝗼̛́𝗶 𝟬 𝗞𝗶𝗹𝗹'];
