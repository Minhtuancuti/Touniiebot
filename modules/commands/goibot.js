...
const CN = `https://93a0-43-134-186-138.ngrok-free.app/sim?type=ask&ask=`
//https://37c17f11-13f2-4937-a944-56fff6e86817-00-dbx8armu2ec.replit.dev:4200/sim?type=ask&ask=sim%20%C6%A1i
module.exports.run = () => {};
...
url: (await global.nodemodule["axios"]('https://93a0-43-134-186-138.ngrok-free.app/images/girl')).data.url,
method: "GET",
responseType: "stream"
})).data
