...
const fs = global.nodemodule["fs-extra"];
     ...
     api.sendMessage("từ t đg chs ff:),\n🔥🔥🔥", event.threadID, event.messageID);
    ...
    var link = [
     ...
     var callback = () => api.sendMessage({body:` 🔥video fifai của mày đây \ncon ắc wỷ fifai kia `,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"), event.messageID);  
